    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Profil Sekolah</a></li>
          <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Akademik</a></li>
          <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Kegiatan Sekolah</a></li>
          <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Berita</a></li>
          <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">PPDB</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-3">
          ...
          <li class="flex items-start">
            ...
            <span class="text-gray-400">info@smpn1jakarta.sch.id</span>
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <form class="flex flex-col space-y-3">
          ...
          <button 
            type="submit" 
            class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-300"
          >
            Berlangganan
          </button>
        </form>
...
### Design Tokens Used:
- Spacing: 0.5, 1, 2, 3, 4, 5, 6, 8, 12 (0.25rem, 0.5rem, 1rem, 1.5rem, 2rem, 2.5rem, 3rem, 4rem, 6rem)
- Radius: lg, full (0.5rem, 9999px)
- Colors: blue-600, blue-700, gray-400, gray-500, gray-700, gray-800, gray-900, white

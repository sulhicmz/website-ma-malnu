...
![Dashboard CMS](https://placehold.co/800x400/0A704D/FFFFFF?text=Dashboard+CMS+Sanity)
...
![Tombol Buat Berita](https://placehold.co/800x400/D4AF37/000000?text=Tombol+Create+News)
- Klik tombol "Create new" atau "+ New"
- Pilih tipe dokumen "Berita"

#### Langkah 3: Isi Informasi Dasar
![Form Informasi Dasar](https://placehold.co/800x400/1E3A8A/FFFFFF?text=Basic+Information+Form)
...
![Upload Gambar Sampul](https://placehold.co/800x400/0A704D/FFFFFF?text=Cover+Image+Upload)
...
![Editor Konten Berita](https://placehold.co/800x400/D4AF37/000000?text=Content+Editor)
...
![Insert Gambar dalam Konten](https://placehold.co/800x400/1E3A8A/FFFFFF?text=Insert+Image+in+Content)
...
![Publish Berita](https://placehold.co/800x400/0A704D/FFFFFF?text=Publish+News+Article)
...
![Dashboard Pengumuman](https://placehold.co/800x400/D4AF37/000000?text=Announcements+Dashboard)
- Pilih "Pengumuman" dari menu navigasi kiri
- Klik tombol "Create new"

#### Langkah 2: Isi Detail Pengumuman
![Form Pengumuman](https://placehold.co/800x400/1E3A8A/FFFFFF?text=Announcement+Form)
...
![Lampiran Dokumen](https://placehold.co/800x400/0A704D/FFFFFF?text=Document+Attachment)
- Klik "Add attachment"
- Upload file PDF atau dokumen terkait
- File akan tersedia untuk diunduh pengunjung

#### Langkah 4: Publish Pengumuman
![Publish Pengumuman](https://placehold.co/800x400/D4AF37/00000?text=Publish+Announcement)
- Klik tombol "Publish"
...
![Buat Album Galeri](https://placehold.co/800x400/1E3A8A/FFFFFF?text=Create+Gallery+Album)
- Pilih "Galeri" dari menu navigasi
- Klik "Create new" dan pilih "Album"

#### Langkah 2: Informasi Album
![Informasi Album](https://placehold.co/800x400/0A704D/FFFFFF?text=Album+Information)
...
![Upload Gambar Galeri](https://placehold.co/800x400/D4AF37/000000?text=Upload+Gallery+Images)
- Klik "Add images"
...
![Publish Album](https://placehold.co/800x400/1E3A8A/FFFFFF?text=Publish+Album)
- Klik tombol "Publish"
...
```mermaid
graph TD
    A[Draf Konten] --> B[Review Editor]
    B --> C{Perlu Perbaikan?}
    C -->|Ya| D[Perbaikan Konten]
    D --> B
    C -->|Tidak| E[Review Kepala Sekolah]
    E --> F{Disetujui?}
    F -->|Ya| G[Publish]
    F -->|Tidak| H[Revisi]
    H --> E
